...
from lib.utils.data_utils import get_mot_datadir


def convert_mot17_to_coco():
    """
    Convert MOT17 dataset to COCO format
    Compatible with ByteTrack conversion script
    """
    # Use unified data directory management
    DATA_PATH = get_mot_datadir()
    ...
    print(f"MOT17 data path: {DATA_PATH}")
